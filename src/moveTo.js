const MoveTo = (() => {
    ...
    MoveTo.prototype.move = function(target, options = {}) {
        ...
        let distance = typeof target === 'number' ? target : target.getBoundingClientRect().top - this.options.offset;
        ...
        const loop = (currentTime) => {
            ...
            const val = this.easeFunctions[options.easing](timeElapsed, from, distance, options.duration, options.offset);
